...
module top ;
	...
	cy_psoc3_pins_v1_10
		#(.id("620a2cc9-0d89-46ea-8cca-2b11f9514ae1"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("72329acd-9c47-489f-879f-93fc6c8c9a8d"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("716d8103-2104-4e5e-9cbb-4b6d06327e62"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__D8_net;
	wire [0:0] tmpFB_0__D8_net;
	wire [0:0] tmpIO_0__D8_net;
	wire [0:0] tmpINTERRUPT_0__D8_net;
	electrical [0:0] tmpSIOVREF__D8_net;

	cy_psoc3_pins_v1_10
		#(.id("d077a49b-8fb5-421d-9ea9-80c1b06d393c"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		D8
		 (.oe(tmpOE__D8_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__D8_net[0:0]}),
		  .io({tmpIO_0__D8_net[0:0]}),
		  .siovref(tmpSIOVREF__D8_net),
		  .interrupt({tmpINTERRUPT_0__D8_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__D8_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

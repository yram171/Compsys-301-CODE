...
#define UART_BT_RX_INTERRUPT_ENABLED           (0u)
#define UART_BT_TX_INTERRUPT_ENABLED           (0u)
...
#define UART_BT_TX_BUFFER_SIZE                 (4u)
#define UART_BT_RX_BUFFER_SIZE                 (4u)
...
#define UART_BT_INIT_RX_INTERRUPTS_MASK \
                                  (uint8)((0 << UART_BT_RX_STS_FIFO_NOTEMPTY_SHIFT) \
...
#define UART_BT_INIT_TX_INTERRUPTS_MASK \
                                  (uint8)((0 << UART_BT_TX_STS_COMPLETE_SHIFT) \
                                        | (0 << UART_BT_TX_STS_FIFO_EMPTY_SHIFT) \
